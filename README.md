...
Se debe ordenar el arreglo de libros por el atributo **name** en orden **Descendente** (de la Z a la A) con el metodo **INSERSICIÓN**. Además, se debe realizar una búsqueda binaria para encontrar un libro con un nombre específico, ignorando mayúsculas y minúsculas en la comparación tanto para el ordenamietno como la busqueda.
